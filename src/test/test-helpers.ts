...
export async function deleteUserRequest(userId: string, authToken: string | null) {
...
export function extractTokenFromCookie(cookieString: string | null, cookieName: string = "authToken"): string | null {
  if (!cookieString) {
    return null;
  }
